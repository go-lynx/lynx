...
func (x *Log) Reset() {
	*x = Log{}
	mi := &file_app_log_conf_log_proto_msgTypes[0]
...
func (*Log) Descriptor() ([]byte, []int) {
	return file_app_log_conf_log_proto_rawDescGZIP(), []int{0}
}
...
var File_app_log_conf_log_proto protoreflect.FileDescriptor

const file_app_log_conf_log_proto_rawDesc = "" +
	"\n" +
	"\x16app/log/conf/log.proto\x12\x17lynx.protobuf.plugin.db\"\xde\x01\n" +
	"\x03log\x12\x14\n" +
...
var (
	file_app_log_conf_log_proto_rawDescOnce sync.Once
	file_app_log_conf_log_proto_rawDescData []byte
)

func file_app_log_conf_log_proto_rawDescGZIP() []byte {
	file_app_log_conf_log_proto_rawDescOnce.Do(func() {
		file_app_log_conf_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_app_log_conf_log_proto_rawDesc), len(file_app_log_conf_log_proto_rawDesc)))
	})
	return file_app_log_conf_log_proto_rawDescData
}

var file_app_log_conf_log_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_app_log_conf_log_proto_goTypes = []any{
	(*Log)(nil), // 0: lynx.protobuf.plugin.db.log
}
var file_app_log_conf_log_proto_depIdxs = []int32{
...
func init() { file_app_log_conf_log_proto_init() }
func file_app_log_conf_log_proto_init() {
	if File_app_log_conf_log_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_app_log_conf_log_proto_rawDesc), len(file_app_log_conf_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_app_log_conf_log_proto_goTypes,
		DependencyIndexes: file_app_log_conf_log_proto_depIdxs,
		MessageInfos:      file_app_log_conf_log_proto_msgTypes,
	}.Build()
	File_app_log_conf_log_proto = out.File
	file_app_log_conf_log_proto_goTypes = nil
	file_app_log_conf_log_proto_depIdxs = nil
}
