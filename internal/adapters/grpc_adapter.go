...
func (a *GrpcServiceAdapter) GetCertificateProvider() CertificateProvider {
	return &CertificateProviderAdapter{}
}

// GetControlPlane returns the control plane interface
func (a *GrpcServiceAdapter) GetControlPlane() ControlPlane {
...
func (a *CertificateProviderAdapter) GetCertificate() []byte {
	provider := lynxapp.Lynx().Certificate()
	if provider == nil {
		return nil
	}
...
func (a *ControlPlaneAdapter) Discovery() interface{} {
	controlPlane := lynxapp.Lynx().GetControlPlane()
	if controlPlane == nil {
		return nil
	}
