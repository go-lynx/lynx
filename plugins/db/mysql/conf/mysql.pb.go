...
const file_mysql_proto_rawDesc = "" +
	"\n" +
	"\vmysql.proto\x12\x17lynx.protobuf.plugin.db\x1a\x1egoogle/protobuf/duration.proto\"\xac\x01\n" +
	"\x05mysql\x12\x16\n" +
...
var file_mysql_proto_depIdxs = []int32{
	1, // 0: lynx.protobuf.plugin.db.mysql.max_idle_time:type_name -> google.protobuf.Duration
