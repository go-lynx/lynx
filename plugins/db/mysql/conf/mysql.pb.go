...
const file_mysql_proto_rawDesc = "" +
	"\n" +
	"\vmysql.proto\x12\x17lynx.protobuf.plugin.db\x1a\x1egoogle/protobuf/duration.proto\"\xeb\x01\n" +
	"\x05mysql\x12\x16\n" +
	...
	"\rmax_idle_time\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\vmaxIdleTimeB7Z5github.com/go-lynx/lynx/plugins/db/mysql/v2/conf;confb\x06proto3"

var (
	file_mysql_proto_rawDescOnce sync.Once
	file_mysql_proto_rawDescData []byte
)

func file_mysql_proto_rawDescGZIP() []byte {
	file_mysql_proto_rawDescOnce.Do(func() {
		file_mysql_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mysql_proto_rawDesc), len(file_mysql_proto_rawDesc)))
	})
...
var file_mysql_proto_goTypes = []any{
	(*Mysql)(nil),               // 0: lynx.protobuf.plugin.db.mysql
	(*durationpb.Duration)(nil), // 1: google.protobuf.Duration
}
var file_mysql_proto_depIdxs = []int32{
	1, // 0: lynx.protobuf.plugin.db.mysql.max_life_time:type_name -> google.protobuf.Duration
	1, // 1: lynx.protobuf.plugin.db.mysql.max_idle_time:type_name -> google.protobuf.Duration
...
func file_mysql_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mysql_proto_rawDesc), len(file_mysql_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
