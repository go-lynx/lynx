...
// This function's purpose is to register the DTM client plugin to the global plugin factory.
func init() {
	...
	// Create a new DTM client plugin instance by calling the NewDTMClient function and return it.
