...
func (x *Kafka) Reset() {
	*x = Kafka{}
	mi := &file_conf_kafka_proto_msgTypes[0]
...
func (*Kafka) Descriptor() ([]byte, []int) {
	return file_conf_kafka_proto_rawDescGZIP(), []int{0}
}
...
func (x *Producer) Reset() {
	*x = Producer{}
	mi := &file_conf_kafka_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Producer) Descriptor() ([]byte, []int) {
	return file_conf_kafka_proto_rawDescGZIP(), []int{1}
}
...
func (x *Consumer) Reset() {
	*x = Consumer{}
	mi := &file_conf_kafka_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Consumer) Descriptor() ([]byte, []int) {
	return file_conf_kafka_proto_rawDescGZIP(), []int{2}
}
...
func (x *SASL) Reset() {
	*x = SASL{}
	mi := &file_conf_kafka_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SASL) Descriptor() ([]byte, []int) {
	return file_conf_kafka_proto_rawDescGZIP(), []int{3}
}
...
var File_conf_kafka_proto protoreflect.FileDescriptor

const file_conf_kafka_proto_rawDesc = "" +
	"\n" +
	"\x10conf/kafka.proto\x12\x1alynx.protobuf.plugin.kafka\x1a\x1egoogle/protobuf/duration.proto\"\xab\x02\n" +
	"\x05Kafka\x12\x18\n" +
	...
	"\bpassword\x18\x04 \x01(\tR\bpasswordB2Z0github.com/go-lynx/plugins/mq/kafka/v2/conf;confb\x06proto3"

var (
	file_conf_kafka_proto_rawDescOnce sync.Once
	file_conf_kafka_proto_rawDescData []byte
)

func file_conf_kafka_proto_rawDescGZIP() []byte {
	file_conf_kafka_proto_rawDescOnce.Do(func() {
		file_conf_kafka_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_conf_kafka_proto_rawDesc), len(file_conf_kafka_proto_rawDesc)))
	})
	return file_conf_kafka_proto_rawDescData
}

var file_conf_kafka_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_conf_kafka_proto_goTypes = []any{
...
var file_conf_kafka_proto_depIdxs = []int32{
...
func init() { file_conf_kafka_proto_init() }
func file_conf_kafka_proto_init() {
	if File_conf_kafka_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_conf_kafka_proto_rawDesc), len(file_conf_kafka_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_conf_kafka_proto_goTypes,
		DependencyIndexes: file_conf_kafka_proto_depIdxs,
		MessageInfos:      file_conf_kafka_proto_msgTypes,
	}.Build()
	File_conf_kafka_proto = out.File
	file_conf_kafka_proto_goTypes = nil
	file_conf_kafka_proto_depIdxs = nil
}
