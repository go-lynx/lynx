// Package lynx_test contains integration tests for the Lynx framework resource management.
// These tests verify resource registration, isolation, and lifecycle management.
package lynx_test
