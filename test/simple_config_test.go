// Package lynx_test contains integration tests for the Lynx framework configuration management.
// These tests verify configuration setting, retrieval, and integration with other features.
package lynx_test
