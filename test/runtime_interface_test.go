// Package lynx_test contains integration tests for the Lynx framework runtime interface.
// These tests verify that TypedRuntimePlugin correctly implements the plugins.Runtime interface.
package lynx_test
