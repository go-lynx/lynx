...
var (
	...
	file_openapi_proto_rawDescData []byte
)

func file_openapi_proto_rawDescGZIP() []byte {
	file_openapi_proto_rawDescOnce.Do(func() {
		file_openapi_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_openapi_proto_rawDesc), len(file_openapi_proto_rawDesc)))
	})
